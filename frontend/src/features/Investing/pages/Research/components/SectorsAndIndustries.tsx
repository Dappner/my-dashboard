...
export function SectorsAndIndustries() {
  ...
  if (sortedSectors.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center rounded-xl border border-gray-100">
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="w-full rounded-full hover:text-blue-700 transition-all duration-200"
