...
export default function SectorPage() {
  const { sectorSlug } = useParams({ strict: false });
      ...
      <PageContainer>
        <div className="p-6">
          ...
          <Button asChild className="mt-4">
            <Link to={investingResearchRoute.to}>Explore All Sectors</Link>
          </Button>
        </div>
      </PageContainer>
    );
  ...
  return (
    <PageContainer>
      ...
      <section>
        ...
        {isErrorIndustries ? (
          <div className="p-4 bg-red-50 text-destructive-foreground rounded-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
            {industries.map((industry) => (
              <Link
                ...
                className="p-3 bg-muted rounded-md hover:bg-gray-200 transition-colors text-center"
              >
