...
import { PieData } from "./components/DividendPieChart";
 ...
 */
export function prepareDividendChartData(holdings: Holding[] | undefined): DividendMonthData[] {
 ...
 */
export function getStockColors(holdings: Holding[] | undefined): Record<string, string> {
