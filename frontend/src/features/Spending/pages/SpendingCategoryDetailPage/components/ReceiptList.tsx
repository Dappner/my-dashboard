...
import { useSpendingCategoryReceipts } from "@/features/Spending/hooks/useSpendingMetrics";
...
export const ReceiptList = ({ categoryId, categoryName }: ReceiptListProps) => {
										...
										<div className="flex justify-between items-start">
											<div>
												...
												<p className="text-sm text-muted-foreground">
													{format(receipt.purchase_date, "MMM d, yyyy")}
												</p>
											</div>
