import { type ReceiptWithItems, receiptsApi } from "@/api/spending/receiptsApi";
...
import { CalendarIcon, MoreHorizontalIcon, TagIcon } from "lucide-react";
			...
			<CardContent className="flex-grow">
				<div className="flex justify-between items-center mb-3">
					<span className="text-xs text-muted-foreground">
						...
						{receipt.receipt_items.length === 1 ? " item" : " items"}
					</span>
				...
				<div className="space-y-2 text-sm">
					{receipt.receipt_items.slice(0, 3).map((item) => (
