...
export const calculatePortfolioMetrics = (
	...
	try {
		...
		const previousCostBasis =
			Number(periodStartMetrics.cost_basis) || currentCostBasis;
		...
		const periodInvestmentChange =
			currentInvestmentValue - previousInvestmentValue;
		...
		if (timeframe === "ALL") {
			periodTotalReturn =
				currentInvestmentValue - currentCostBasis + periodDividendsReceived;
