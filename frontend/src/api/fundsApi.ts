...
export const fundApiKeys = {
  all: ["funds"] as const,
  topHoldings: (tickerId: string) => [...fundApiKeys.all, "topHoldings", tickerId] as const,
  sectorWeightings: (tickerId: string) => [...fundApiKeys.all, "sectorWeightings", tickerId] as const,
  assetClasses: (tickerId: string) => [...fundApiKeys.all, "assetClasses", tickerId] as const,
};
